 ...
 */
package com.github.kylichist.khttp2.requests

import com.github.kylichist.khttp2.extensions.putAllIfAbsentWithNull
import com.github.kylichist.khttp2.extensions.writeAndFlush
import com.github.kylichist.khttp2.structures.authorization.Authorization
import com.github.kylichist.khttp2.structures.files.FileLike
import com.github.kylichist.khttp2.structures.maps.CaseInsensitiveMutableMap
import com.github.kylichist.khttp2.structures.parameters.Parameters
...
class GenericRequest internal constructor(
    ...
    companion object {
        val DEFAULT_HEADERS = mapOf(
            ...
            "User-Agent" to "com/github/kylichist/khttp2/1.0.0-SNAPSHOT"
        )
